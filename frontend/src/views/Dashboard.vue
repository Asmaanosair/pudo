  ...
  <div>
    ...
    <CRow>
      ...
      <CCol sm="6" lg="3">
          ...
          <CWidgetDropdown
            color="success"
           :text="$i18n.translate('dashboard.drivers_online')"
          >
            <CCol  col="3" >
                  <small class="text-muted">Online</small><br>
                  <strong class="h4">{{ onlineDrivers }}</strong>
            </CCol>
          </CWidgetDropdown>
     ...
     <CCol sm="6" lg="3">
        ...
        <CWidgetDropdown
         color="secondary"
        :text="$i18n.translate('dashboard.drivers-offilne')"
        >
          <CCol  col="3" >

            <small class="text-muted">Offline</small><br>
            <strong class="h4">{{ allDrivers - onlineDrivers }}</strong>
    ...
    <CCol sm="6" lg="3">
        ...
        <CWidgetDropdown
          color="primary"
          :text="$i18n.translate('dashboard.all-drivers')"
        >
            <CCol  col="3" >

              <small class="text-muted">All</small><br>
              <strong class="h4">{{ allDrivers  }}</strong>
            ...
            <CRow>
              <CCol sm="12" lg="6">
                <CRow>
                  <CCol sm="6">
                    <CCallout color="info">
                      <small class="text-muted">{{ $t('dashboard.new_clients') }}</small><br>
                      <strong class="h4">9,123</strong>
                    </CCallout>
                  </CCol>
                  <CCol sm="6">
                    <CCallout color="danger">
                      <small class="text-muted">{{ $t('dashboard.recurring_clients') }}</small><br>
                ...
                <CRow>
                  <CCol sm="6">
                    <CCallout color="warning">
                      <small class="text-muted">{{ $t('dashboard.pageviews') }}</small><br>
                      <strong class="h4">78,623</strong>
                    </CCallout>
                  </CCol>
                  <CCol sm="6">
                    <CCallout color="success">
                      <small class="text-muted">{{ $t('dashboard.organic') }}</small><br>
  ...
  data () {
    return {
      ...
      tableFields: [
        ...
        { key: 'user', label: this.$i18n.translate('dashboard.user') },
        { key: 'country', label: this.$i18n.translate('dashboard.country'), _classes: 'text-center' },
        { key: 'usage', label: this.$i18n.translate('dashboard.usage') },
        { key: 'payment', label: this.$i18n.translate('dashboard.payment_method'), _classes: 'text-center' },
        { key: 'activity', label: this.$i18n.translate('dashboard.activity') },
      ]
...
*/
  ...
  methods: {
   ...
   getDrivers (){
      ...
      let self= this;
      this.items = [];
      axios.get(  '/api/drivers?' +  '&token='+localStorage.getItem("api_token"),
      {})
