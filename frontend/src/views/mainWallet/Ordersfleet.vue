          ...
          <CCol sm="12">
            ...
            >
              <template #created_at-filter="{item}">
                ...
                <input type="date" v-model="currentOrdersColumnFilter.created_at" id="created_at" class="form-control" placeholder="To Date" @change="setDataFilter()" />
              ...
              <template #client_name-filter="{item}" >
                ...
                <model-select :options="clients"
                              ...
                              @input="setDataFilter()" v-model="currentOrdersColumnFilter.user_id"
...
export default {
  ...
  methods: {
    ...
    getCurrentOrders() {
      ...
      axios
        .get(
          "/api/main-fleet/"+self.$route.params.id+"?page=" +
